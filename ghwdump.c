...
static void add_single_signal(int **signalSet, int *nbSignals, int signal) {
...
static void add_signal_range(int **signalSet, int *nbSignals, const char *s,
                             const char *e) {
...
static void add_signals(int **signalSet, int *nbSignals, const char *arg) {
  int c = -1;
  const char *e;
  const char *s = e = arg;
  while (0 != c) {
...
static void disp_string_table(struct ghw_handler *hp) {
  int i;
  printf("String table:\n");
